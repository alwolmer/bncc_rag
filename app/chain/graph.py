...
def run_chain(chain: Graph, plano: str, etapa: str, ano: str, componentes: list) -> Dict:
    ...
    initial_state = {
        ...
        "codigos_bncc": [],
        "avaliacao_estrutura": {
            "objetivos": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
            "conteudos": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
            "metodologia": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
            "avaliacao": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
            "recursos": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
            "materiais": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
            "tempo": {"presente": False, "adequado": False, "identificacao": "", "sugestao_melhoria": None},
        },
